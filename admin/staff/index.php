        ...
        <div class="card mt-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="add.php" class="btn btn-primary">
                    <i class="bi bi-plus-lg"></i> <span class="d-none d-sm-inline">Add (New Staff)</span>
                </a>
            </div>
            <div class="card-body">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    Actions
                                    <br>
                                    <small class="text-muted">(Modify / Delete)</small>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Actions">
                                        ...
                                        <a href="view.php?id=<?php echo $staff['id']; ?>" 
                                           class="btn btn-action btn-info" data-bs-toggle="tooltip" title="View Staff">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <!-- Edit/Modify -->
                                        <a href="edit.php?id=<?php echo $staff['id']; ?>" 
                                           class="btn btn-action btn-warning" data-bs-toggle="tooltip" title="Edit (Modify) Staff">
                                    ...
                                    <div class="d-md-none mt-2">
                                        <a href="edit.php?id=<?php echo $staff['id']; ?>" class="btn btn-warning btn-sm w-100 mb-1">Modify</a>
                                        <button type="button" onclick="confirmDelete(<?php echo $staff['id']; ?>)" class="btn btn-danger btn-sm w-100">Delete</button>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                ...
                <div class="mt-2">
                    <span class="badge bg-warning text-dark"><i class="bi bi-pencil"></i> Modify</span>
                    <span class="badge bg-danger"><i class="bi bi-trash"></i> Delete</span>
                    <small class="text-muted ms-2">Legend: Modify / Delete</small>
                </div>
            </div>
        </div>
    </div>
