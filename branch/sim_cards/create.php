...
$page_title = 'New SIM Card Issue to Staff';
...
// Get yesterday's closing stock as opening (per index.php logic)
...
// Today's SIM card transaction for this branch (if any)
$today = date('Y-m-d');
...
<head>
    <meta charset="UTF-8">
    <title>New SIM Card Issue to Staff</title>
...
<body class="bg-light">
    <div class="container py-4">
        <div class="mb-3 text-center">
            <h2>SIM Cards: Issue to Staff</h2>
            <div class="small text-muted"><?= htmlspecialchars($username) ?> (Branch <?= htmlspecialchars($branch_id) ?>)</div>
        </div>
        <div class="card shadow">
            <div class="card-body">
                <form action="process_issue.php" method="post" autocomplete="off" id="simIssueForm">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Branch Total Available SIM Card Stock</label>
