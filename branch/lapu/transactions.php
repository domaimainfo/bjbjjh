...
$page_title = 'All LAPU Transactions';
...
// Fetch LAPU transactions (all if no date, else filtered)
if ($filter_date) {
    $stmt = $conn->prepare("
        SELECT l.*, 
    ...
    $lapu_txns = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
<head>
    <meta charset="UTF-8">
    <title>All LAPU Transactions</title>
...
<body class="bg-light">
    ...
    <div class="sidebar d-none d-lg-block">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link" href="index.php"><i class="bi bi-phone"></i> LAPU</a>
            <a class="nav-link active" href="transactions.php"><i class="bi bi-list"></i> LAPU Transactions</a>
    ...
    <div class="main-content">
        <div class="container-fluid py-3">
            ...
            <!-- LAPU Transactions Table -->
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">LAPU Transactions<?= $heading_date ?></h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle text-center">
                            ...
                            <tbody>
                                ...
                                <?php endforeach; ?>
                                <?php if (empty($lapu_txns)): ?>
                                <tr>
                                    <td colspan="11" class="text-muted">No LAPU transactions found for this branch<?= $filter_date ? ' on this day' : '' ?>.</td>
                                </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
