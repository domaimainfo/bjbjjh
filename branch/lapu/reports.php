...
if ($from_date && $to_date) {
    $where[] = "DATE(l.transaction_date) BETWEEN ? AND ?";
    $params[] = $from_date;
    $params[] = $to_date;
}
if ($staff_id) {
...
$sql = "
    SELECT l.*, b.branch_name, s.full_name as staff_name, ba.bank_name, ba.account_number
    FROM lapu l
            ...
            <table class="table table-bordered table-hover align-middle mb-0">
                ...
                <tfoot class="table-light">
                    <tr>
                        ...
                        <th>₹<?php echo number_format($totals['cash_received'], 2); ?></th>
