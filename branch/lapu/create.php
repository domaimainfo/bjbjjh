...
$page_title = 'New LAPU Issue to Staff';
...
// Get yesterday's closing balance as opening (per index.php logic)
...
// Today's LAPU transaction for this branch (if any)
$today = date('Y-m-d');
...
<head>
    <meta charset="UTF-8">
    <title>New LAPU Issue to Staff</title>
...
<body class="bg-light">
    <div class="container py-4">
        <div class="mb-3 text-center">
            <h2>LAPU: Issue to Staff</h2>
            <div class="small text-muted"><?= htmlspecialchars($username) ?> (Branch <?= htmlspecialchars($branch_id) ?>)</div>
        </div>
        <div class="card shadow">
            <div class="card-body">
                <form action="process_issue.php" method="post" autocomplete="off" id="lapuIssueForm">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Branch Total Available LAPU Stock</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" min="0" max="<?= $total_available ?>" id="quantity" name="quantity" class="form-control" value="<?= htmlspecialchars($_POST['quantity']) ?>" required>
                        <div class="form-text">Max: <?= number_format($total_available, 2) ?></div>
                    </div>
                    <div class="mb-3">
